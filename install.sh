...
packages_arch="stow alsa-utils brave-bin firefox htop cava clipmenu xsel xclip clipnotify cmatrix corrupter-bin cowsay cpulimit dbus-python discord dmidecode docker dunst exfatprogs feh fish flameshot scrot gnu-netcat i3-wm i3lock-color imagemagick inotify-tools kitty ksshaskpass libva-intel-driver lxappearance mesa mpv dropbox nemo nemo-dropbox neofetch obsidian picom pipewire-alsa pipewire-pulse polybar python-gobject python-pip python-pywal python-pywalfox ranger redshift rofi simplescreenrecorder slop sweet-gtk-theme-dark candy-icons-git telegram-desktop tesseract tesseract-data-osd tesseract-data-eng tesseract-data-por tldr tmux ttf-hack ttf-hack-nerd ttf-icomoon-feather noto-fonts-emoji unzip vulkan-icd-loader vulkan-intel wireplumber wmctrl xdotool xorg-xwininfo xdg-user-dirs xorg-server xorg-xinit zbar lm_sensors man-db man-pages neovim"
